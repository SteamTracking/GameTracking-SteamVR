      ...
      chunkid: (module, module_exports, __webpack_require__) => {
        ...
        class _ extends _.Component {
          ...
          onKeyboardInfoChanged(_) {
            if (_.visible) {
              ...
              this.setState({
                ...
                bMinimalMode: !!(_.QRg.Minimal & _.keyboardFlags),
                bMultilinePreview: _.lineMode == _.ba0.MultipleLines,
                text: _,
                textPos: _.length,
              }),
          ...
          bShowPasswordPreview() {
            return this.state.inputMode == _.XlW.Password;
          }
          getLayoutFile(_) {
