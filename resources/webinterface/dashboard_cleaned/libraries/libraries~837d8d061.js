...
(self.webpackChunkvrwebui = self.webpackChunkvrwebui || []).push([
  [267, 260, 154, 982, 47, 264, 602],
  {
    ...
    chunkid: (module, module_exports, __webpack_require__) => {
      ...
      function _(_) {
        var _ = _.counterClockwise,
          _ = _.dashRatio,
          _ = _.pathRadius,
          _ = 2 * Math._ * _,
          _ = (1 - _) * _;
        return {
          strokeDasharray: _ + "px " + _ + "px",
          strokeDashoffset: (_ ? -_ : _) + "px",
        };
      }
      var _ = (function (_) {
        function _() {
          ...
          (function (_, _) {
            ...
            _(_, _),
              (_.prototype =
                null === _
                  ? Object.create(_)
                  : ((_.prototype = _.prototype), new _()));
          })(_, _),
          (_.prototype.getBackgroundPadding = function () {
            return this.props.background ? this.props.backgroundPadding : 0;
          }),
          (_.prototype.getPathRadius = function () {
            return (
              50 - this.props.strokeWidth / 2 - this.getBackgroundPadding()
            );
          }),
          (_.prototype.getPathRatio = function () {
            var _ = this.props,
              _ = _.value,
              _ = _.minValue,
              _ = _.maxValue;
            return (Math.min(Math.max(_, _), _) - _) / (_ - _);
          }),
